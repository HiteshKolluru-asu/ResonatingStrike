"""
Multi-Collection RAG Pipeline for First Stand 2026

Instead of a single ChromaDB collection + static text blob, this version:
1. Creates separate collections for: comments, players, champions, tournament
2. Searches ALL collections for each query
3. Assembles a structured prompt with labeled sections (facts vs opinions)

Usage: python3 multi_collection_search.py
...
def main():
    ...
    print("\n✅ Multi-collection RAG pipeline ready! (Local Ollama via gemma2)")
    ...
    while True:
        ...
        if response.status_code == 200:
            ...
            conversation_history.append({"role": "user", "content": query})  # Keep clean history without context block
